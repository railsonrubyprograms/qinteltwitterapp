...
class Twitter(object):
    ...
    def __init__(self):
        ...
        # common words found from: https://www.englishclub.com/vocabulary/common-words-100.htm
        commonWords = open("commonWords.txt", "r")
        self.commonWords = set()
        self.setCommonWords(commonWords)
        # happy words found from: https://github.com/jeffreybreen/twitter-sentiment-analysis-tutorial-201107/blob/master/data/opinion-lexicon-English/positive-words.txt
        happyWords = open("happyWords.txt", "r")
        self.happyWords = set()
        self.setHappyWords(happyWords)
        # negative words found from: https://github.com/jeffreybreen/twitter-sentiment-analysis-tutorial-201107/blob/master/data/opinion-lexicon-English/negative-words.txt
    ...
    def favoriteApp(self, web):
        ...
        if (web):
            for status in self.statuses:
                # parse the source information text
...
# Wrapper function that you run to interact with the twitter application
def runTwitter():
    twitter = Twitter()
    twitter.run()
    twitter.help()
